    ...
    <div className="relative">
      ...
      >
        {categories.map((category, index) => (
          ...
          >
            <div className="bg-gradient-to-br from-gray-800 to-gray-900 hover:from-blue-900/30 hover:to-purple-900/30 border border-gray-700/50 rounded-xl p-5 w-[180px] h-[140px] flex flex-col items-center justify-center transition-all duration-300">
